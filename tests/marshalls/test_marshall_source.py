...
class UserMarshall(Marshall):
    ...
    details: fields.MarshallField = fields.MarshallField(field_type=str, source="name")
...
async def test_marshall_gets_from_source_string(async_client):
    data = {
        "name": "Edgy",
    ...
    assert response.json() == {"name": "Edgy", "details": "Edgy"}
