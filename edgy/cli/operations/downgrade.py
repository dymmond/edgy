...
@click.option("-x", "--arg", multiple=True, help="Additional arguments consumed by custom env.py scripts")
@click.command()
@click.argument("revision", default="-1")
def downgrade(env: MigrationEnv, directory: str, sql: bool, tag: str, arg: Any, revision: str) -> None:
